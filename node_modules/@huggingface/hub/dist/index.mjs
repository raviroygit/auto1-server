...
import { writeFile, rename, symlink, lstat as lstat2, mkdir, stat as stat2 } from "fs/promises";
...
async function snapshotDownload(params) {
  ...
  if (revision !== commitHash) {
    ...
    await mkdir2(dirname2(refPath), { recursive: true });
    await writeFile2(refPath, commitHash);
  }
